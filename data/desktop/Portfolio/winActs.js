obtain(['µ/utilities.js', 'src/gallery.js'], function(utils, gal) {
  ...
  main.changeSize(window.innerWidth * .90, window.innerHeight * .90);
  main.updatePosition(window.innerWidth * .05, window.innerHeight * .01);
